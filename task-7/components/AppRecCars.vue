...
const recomCars = await cars.getAllCars
...
<template>
    ...
    <div class="cr__recommendationCars mt-8 grid gap-8 grid-cols-4">
        <div v-for="car in recomCars" class="cr__carWrapper flex flex-col p-8 bg-white rounded-lg">
    ...
    <div class="cr__showMore flex justify-center mt-16 relative">
        ...
        <p class="absolute right-0 top-3 text-gray-500">{{ recomCars.length }} Cars</p>
    </div>
</template>
